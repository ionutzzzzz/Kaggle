...
param_grid = {
    # 'n_estimators': [50, 100, 200],                                 # x 3
    'max_depth': [10, 20, 30],                                      # x 3
    'min_samples_split': [2, 5, 10],                                # x 3 
    'min_samples_leaf': [1, 2, 4],                                  # x 3
    # 'bootstrap': [True, False],                                     # x 2
    'criterion': ['gini', 'entropy'],                               # x 2
    # 'max_features': ['auto', 'sqrt', 'log2', None],                 # x 4
    # 'class_weight': [None, 'balanced', 'balanced_subsample'],       # x 3
    # 'warm_start': [True, False],                                    # x 2
    # 'oob_score': [True, False],                                     # x 2
}
...
text = [
    f'Model algorithm: {RandomForestClassifier()}\n\n',
